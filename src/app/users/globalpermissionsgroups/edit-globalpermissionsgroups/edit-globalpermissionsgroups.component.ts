...
export class EditGlobalpermissionsgroupsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.updateForm = new FormGroup({
      ...
      'permAgentWakeOnLan': new FormControl(),
      ...
      'permAgentStatWakeOnLan': new FormControl(),
  ...
  private initForm() {
    ...
    if (this.editMode) {
      ...
      this.updateForm = new FormGroup({
        ...
        'permAgentWakeOnLan': new FormControl(result['permAgentWakeOnLan']),
        ...
        'permAgentStatWakeOnLan': new FormControl(result['permAgentStatWakeOnLan']),
  ...
  selectPerm(){
    this.updateForm.patchValue({
      'permissions': {
        ...
        'permAgentWakeOnLan': this.selected,
        ...
        'permAgentStatWakeOnLan': this.selected,
